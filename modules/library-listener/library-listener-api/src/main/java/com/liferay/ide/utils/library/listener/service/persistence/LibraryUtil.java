...
public class LibraryUtil {
	...
	*/
	public static List<Library> findByRepositoryId(long repositoryId) {
	...
	*/
	public static Library findByRepositoryId_First(long repositoryId,
		OrderByComparator<Library> orderByComparator)
	...
	*/
	public static Library fetchByRepositoryId_First(long repositoryId,
		OrderByComparator<Library> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchLibraryException if a matching library could not be found
	*/
	public static Library findByRepositoryId_Last(long repositoryId,
		OrderByComparator<Library> orderByComparator)
		throws com.liferay.ide.utils.library.listener.exception.NoSuchLibraryException {
		return getPersistence()
	...
	*/
	public static Library fetchByRepositoryId_Last(long repositoryId,
		OrderByComparator<Library> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Library[] findByRepositoryId_PrevAndNext(long libraryId,
		long repositoryId, OrderByComparator<Library> orderByComparator)
		throws com.liferay.ide.utils.library.listener.exception.NoSuchLibraryException {
		return getPersistence()
				   .findByRepositoryId_PrevAndNext(libraryId, repositoryId,
			orderByComparator);
	}
