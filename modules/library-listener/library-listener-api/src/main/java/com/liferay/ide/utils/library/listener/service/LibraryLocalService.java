...
public interface LibraryLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LibraryLocalServiceUtil} to access the library local service. Add custom service methods to {@link com.liferay.ide.utils.library.listener.service.impl.LibraryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Library createLibrary(long libraryId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Library deleteLibrary(long libraryId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Library fetchLibrary(long libraryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Library getLibrary(long libraryId) throws PortalException;
