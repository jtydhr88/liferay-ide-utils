...
package com.liferay.ide.utils.library.listener.service.base;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.ide.utils.library.listener.service.impl.LibraryLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class LibraryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LibraryLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.ide.utils.library.listener.service.LibraryLocalServiceUtil} to access the library local service.
	 */
	...
	public Library createLibrary(long libraryId) {
		return libraryPersistence.create(libraryId);
	}
	...
	public Library deleteLibrary(long libraryId) throws PortalException {
		return libraryPersistence.remove(libraryId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Library.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return libraryPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return libraryPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return libraryPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Library fetchLibrary(long libraryId) {
		return libraryPersistence.fetchByPrimaryKey(libraryId);
	}
	...
	public Library getLibrary(long libraryId) throws PortalException {
		return libraryPersistence.findByPrimaryKey(libraryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("libraryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(libraryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Library.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("libraryId");
	 ...
	 */
	public com.liferay.ide.utils.library.listener.service.RepositoryLocalService getRepositoryLocalService() {
	...
	public void setRepositoryLocalService(
		com.liferay.ide.utils.library.listener.service.RepositoryLocalService repositoryLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.ide.utils.library.listener.model.Library",
			libraryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.ide.utils.library.listener.model.Library");
	}
	...
	@BeanReference(type = com.liferay.ide.utils.library.listener.service.RepositoryLocalService.class)
	protected com.liferay.ide.utils.library.listener.service.RepositoryLocalService repositoryLocalService;
