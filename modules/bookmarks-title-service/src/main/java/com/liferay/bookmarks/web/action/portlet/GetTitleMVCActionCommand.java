 ...
 * details.
 */
package com.liferay.bookmarks.web.action.portlet;
...
public class GetTitleMVCActionCommand extends BaseMVCActionCommand {
	...
	private String _getTitleFromHtml(String url) {
		...
		try {
			...
			if (charset != null) {
				...
				charsetName = getCharsetFromMetaTag(html, _REGEX_CHARSET, "UTF-8");
			}

			title = getCharsetFromMetaTag(html, _REGEX_TITLE, charsetName);
	...
	private String getCharsetFromMetaTag(byte[] html, String regex, String charsetName) {
