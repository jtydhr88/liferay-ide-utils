		...
		<div class="lfr-form-content">
			...
			<aui:fieldset-group markupView="lexicon">
				<aui:fieldset>
					...
					<portlet:actionURL name="/bookmarks/get_title" var="editEntryURL"></portlet:actionURL>			
					
					<aui:script use="aui-io-request">
								AUI.$('#<portlet:namespace />url').on(
									'change',
									function(event) { 
										var input = AUI.$('#<portlet:namespace />url');
										
										A.io.request('${editEntryURL}', {
											  								method: 'post',
											  								dataType: String,
											  								data:{
											  									requestPage : input.val()
											  								},
											 								on: {success: function(data,textstatus,xhr){
											 															
											 										var titleValue = xhr.getResponseHeader('TitleValue');
											 															
											 										if(typeof(titleValue) != "object"){
											 										    var ss = decodeURIComponent(titleValue);
